...
YEARS_TO_PROCESS = range(1958, 2024)
...
def standardize_resolution():
    ...
    This ensures robust trend analysis as per Rohrer et al. (2020).
    """
...
def bandpass_filter_gpu(data_3d):
    ...
    """
    data_gpu = cp.asarray(data_3d, dtype=cp.float64)
...
def process_year_correct(year, data_dir, climatology):
    ...
    try:
        ...
        ds = xr.open_mfdataset(extended_files, combine='by_coords').squeeze().load()
