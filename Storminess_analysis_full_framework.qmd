...
-   PHASE 3: Trend analysis
    ...
    -   3.1 Pan-Arctic trend analysis (all metrics simultaneously)
    ...
    -   3.5 Period comparison (pre- vs. post-regime shift, if warranted by 3.1–3.3)
...
|-----------------|---------------|---------------|-----------|
| eke_mean        | 12.27 m²/s²   | 2.80 m²/s²    | 0.153     |
| eke_p90         | 29.47 m²/s²   | 6.72 m²/s²    | 0.149     |
| eke_p95         | 40.74 m²/s²   | 9.18 m²/s²    | 0.152     |
| eke_p99         | 66.38 m²/s²   | 14.82 m²/s²   | 0.160     |
...
- **Autocorrelation**: All metrics exhibit $\rho_1>0.1$, requiring 
...
# NOTE: We do NOT save metrics_arctic
#       Gridded data can be reloaded from NetCDF when needed for spatial analysis
save(
  # Coordinate data
  lat, lon, lat_arctic, time_dates,
  
  # Area-weighted time series (THIS IS WHAT WE NEED)
