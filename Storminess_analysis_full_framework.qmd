...
for (vname in names(spatial_results)) {
  ...
  p_ann <- make_panel(
    ...
    theme(plot.subtitle = element_text(size = SUBTITLE_SIZE, colour = "grey40", hjust = 0.5))

  ggsave(file.path(FIG_PHASE3, cfg$fig_annual),
         p_ann, width = 10, height = 10, dpi = 300, bg = "white")
  ...
  fig_seas <- (season_panels[["DJF"]] + season_panels[["MAM"]] +
    ...
    plot_annotation(
      ...
      theme = theme(
        ...
        plot.subtitle = element_text(size = SUBTITLE_SIZE, colour = "grey40", hjust = 0.5)
      )
    )

  ggsave(file.path(FIG_PHASE3, cfg$fig_seasonal),
         fig_seas, width = 14, height = 14, dpi = 300, bg = "white")
