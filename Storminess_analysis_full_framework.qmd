...
output_dir <- file.path(processed_dir, "mechanistic_diagnostics_CORRECTED")
if (!dir.exists(output_dir)) {
  dir.create(output_dir, recursive = TRUE)
}

write.csv(table_annual, 
          file.path(output_dir, "Table_Mechanistic_Annual_CORRECTED.csv"), 
          row.names = FALSE)
write.csv(all_results, 
          file.path(output_dir, "Table_Mechanistic_Complete_CORRECTED.csv"), 
          row.names = FALSE)
