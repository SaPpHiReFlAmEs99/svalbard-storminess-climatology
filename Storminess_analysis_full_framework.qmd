...
shared_max <- max(
  ...
  max(clim_polar_masked[["eke_mean"]], na.rm = TRUE)
)
...
climatology_maps_full[["p95_mean_ratio"]] <-
  climatology_maps_full$eke_p95 / climatology_maps_full$eke_mean
...
cat(" ✓ Saved: Fig06a_EKE_Intensity_Climatology.png\n")
...
cat(" ✓ Saved: Fig06b_EKE_Distribution_Climatology.png\n")


# Also save individual high-res versions for thesis appendix / flexibility
# ==========================================================================
...
where: - **TKE** (Total Kinetic Energy): Complete kinetic energy of the atmospheric flow - **MKE** (Mean Kinetic Energy): Energy in the time-mean circulation (jet streams, stationary waves) - **EKE** (Eddy Kinetic Energy): Energy in transient disturbances (cyclones, anticyclones)
...
1.  **Overall atmospheric energization**: TKE increases, with energy distributed to both MKE and EKE
2.  **Energy redistribution**: TKE remains stable but the mean flow becomes more unstable, converting MKE to EKE
3.  **Decreased mean flow with stable eddies**: MKE decreases while EKE remains unchanged
