...
#
# PURPOSE:
#   Single source-of-truth configuration block for all analytical phases.
#   Every path, variable name, colour, and statistical parameter used
#   downstream is defined here exactly once.
#
# USAGE:
#   Run this chunk first in every session, before any phase-specific chunks.
#
# ============================================================================
...
if (format(dates[length(dates)]) != "2025-12-01") {
  stop(sprintf(
...
# Load Phase 1 data
DATA_DIRECTORY <- here::here("Data", "processed", "analysis_ready", "Phase1_Prepared_Data.RData")
...
# Load Phase 1 data
DATA_DIRECTORY <- here::here("Data", "processed", "analysis_ready",
